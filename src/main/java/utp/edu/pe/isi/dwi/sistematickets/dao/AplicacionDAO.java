...
public class AplicacionDAO {
    ...
    public List<AplicacionDTO> listarAplicaciones() {
        ...
        String sql = "SELECT id_aplicacion, id_empresa, tipo_aplicacion FROM Aplicacion ORDER BY id_aplicacion";
    ...
    public List<AplicacionDTO> listarPorEmpresa(int idEmpresa) {
        List<AplicacionDTO> lista = new ArrayList<>();
        String sql = "SELECT id_aplicacion, id_empresa, tipo_aplicacion FROM Aplicacion WHERE id_empresa = ? ORDER BY id_aplicacion";
